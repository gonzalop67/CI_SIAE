...
<html lang="es">
        ...
        <script type="text/javascript">
            ...
            function eliminar(id_usuario) {
                if(confirm("¿Seguro que desea eliminar este usuario?")){
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('usuario/eliminar') ?>",
                        {
                        ...
                        function(respuesta){
                            ...
                            alert(resp['mensaje']);
                            location.href = "<?php echo site_url('usuario') ?>"
                        }
                    );
                }
            }
    ...
    <body>
                ...
                <tbody>
                    ...
                    if ($usuarios) {
                        ...
                        foreach ($usuarios->result() as $usuario) {
                            ...
                            $fullname = $usuario->us_fullname;
                            $perfil = $usuario->pe_nombre;
                            echo "<tr><td>$id</td>\n";
                            echo "<td>$login</td>\n";
                            echo "<td>$fullname</td>\n";
                            echo "<td>$perfil</td>\n";
                            echo "<td><a href='usuario/editar/$id'>Editar</a></td>\n";
                            echo "<td><a href='#' onclick='eliminar(".$id.")'>Eliminar</a></td></tr>\n";
                        }
                    } else {
                        echo "<td colspan='5' align='center'>No se han definido usuarios todavia...</td>";
                    }
                    ?>
                </tbody>
            </table>
        ...
        <div class="text-center" style="margin-bottom: 8px;">
            <a class="btn btn-default" href="<?php echo site_url('usuario/nuevo') ?>" role="button">NUEVO USUARIO</a>
        </div>
