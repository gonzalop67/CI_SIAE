...
<html lang="es">
    ...
    <head>
        ...
        <title>SIAE Cambiar Clave</title>
        ...
        <script type="text/javascript">
            $(document).on("ready", function () {
                ...
                $("#login-form").submit(function(event){
                    ...
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('usuario/cambiar_clave_post'); ?>",
                        {
                            clave_actual: $("#clave_actual").val(),
                            clave_nueva: $("#clave_nueva").val(),
                            clave_confirmada: $("#clave_confirmada").val()
                        },
                        function(respuesta){
    ...
    <body>
        ...
        <form id="login-form" class="form-signin" action="" method="post">
            <h4 class="form-signin-heading">Cambio de la contraseña</h4>
            <input type="password" id="clave_actual" name="clave_actual" class="form-control" placeholder="Ingrese Clave Actual" required autofocus>
            <input type="password" id="clave_nueva" name="clave_nueva" class="form-control" placeholder="Ingrese Clave Nueva" required>
            <input type="password" id="clave_confirmada" name="clave_confirmada" class="form-control" placeholder="Redigite Clave Nueva" required>
            <button id="btnActualizar" class="btn btn-lg btn-primary btn-block" type="submit">Actualizar</button>
        </form>
        ...
        <div class="container-fluid margin-padding text-center">
            <div class="row">
                ...
                <div id="img_loader" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 div-oculto">
                    ...
                    <img src="../img/ajax-loader.gif" alt="Procesando...">
                </div>
            </div>
        </div>
