...
<html lang="es">
    ...
    <head>
        ...
        <title>SIAE Editar SubMenú</title>
        ...
        <script type="text/javascript">
            $(document).on("ready", function () {
                ...
                $("#edit_submenu").submit(function(event){
                    event.preventDefault();
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('menu/actualizar'); ?>",
                        {
                            id_menu: "<?php echo $idMenu ?>",
                            mnu_texto: $("#texto").val(),
    ...
    <body>
        ...
        <!-- Aqui va el formulario de edición de un nuevo perfil -->
        <form id="edit_submenu" class="form-horizontal form-margin" role="form" method="post" action="">
            ...
            <div class="form-group" style="margin-top: 8px">
                ...
                <div class="col-sm-10">
                    <input class="form-control" id="texto" name="texto" type="text" placeholder="Texto del Menú" value="<?php echo $menu->mnu_texto ?>" required autofocus>
                </div>    
            </div>
            <div class="form-group" style="margin-top: 8px">
                <label for="enlace" class="col-sm-2 control-label">Enlace:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="enlace" name="enlace" type="text" placeholder="Enlace del Menú" value="<?php echo $menu->mnu_enlace ?>" required>
                </div>    
            </div>
