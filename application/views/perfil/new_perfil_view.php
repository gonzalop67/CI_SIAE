...
<html lang="es">
    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).on("ready", function () {
                ...
                $("#new_perfil").submit(function(event){
                    event.preventDefault();
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('perfil/recibirdatos'); ?>",
                        {
                            nombre: $("#nombre").val()
                        },
                        function(respuesta){
    ...
    <body>
        ...
        <div class="row text-center color1">
            <h3>INGRESAR UN NUEVO PERFIL</h3>
        </div>
        ...
        <form id="new_perfil" class="form-horizontal form-margin" role="form" method="post" action="">
            <div class="form-group" style="margin-top: 8px">
                <label for="nombre" class="col-sm-2 control-label">Nombre:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre del Perfil" value="" required autofocus>
                </div>    
            </div>
        ...
        <div class="text-center" style="margin-bottom: 8px;">
            <a class="btn btn-default" href="<?php echo site_url('perfil') ?>" role="button">Regresar a la lista</a>
        </div>
