...
<html lang="es">
        ...
        <script type="text/javascript">
            $(document).on("ready", function () {
                ...
                $("#edit_perfil").submit(function(event){
                    ...
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('perfil/actualizar/'.$id); ?>",
                        {
                            nombre: $("#nombre").val()
                        },
                        function(respuesta){
    ...
    <body>
        ...
        <form id="edit_perfil" class="form-horizontal form-margin" role="form" method="post" action="">
            <div class="form-group" style="margin-top: 8px">
                <label for="nombre" class="col-sm-2 control-label">Nombre:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre del Perfil" 
                        value="<?php echo $perfil->pe_nombre ?>" required autofocus>
                </div>
            </div>
