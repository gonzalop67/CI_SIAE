...
<html lang="es">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function eliminar(id_perfil) {
                if(confirm("¿Seguro que desea eliminar este perfil?")){
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('perfil/eliminar') ?>",
                        {
                            id_perfil: id_perfil
                        },
                        function(respuesta){
                            ...
                            alert(resp['mensaje']);
                            location.href = "<?php echo site_url('perfil') ?>"
                        }
                    );
                }
            }
    ...
    <body>
        ...
        <div class="row text-center color1">
            <h3>LISTA DE PERFILES EXISTENTES</h3>
        </div>
                ...
                <tbody>
                    ...
                    if ($perfiles) {
                        ...
                        foreach ($perfiles->result() as $perfil) {
                            ...
                            echo "<tr><td>$id</td>\n";
                            echo "<td>$name</td>\n";
                            echo "<td><a href='perfil/editar/$id'>Editar</a></td>\n";
                            echo "<td><a href='#' onclick='eliminar(".$id.")'>Eliminar</a></td></tr>\n";
                        }
                    } else {
                        echo "<td colspan='4' align='center'>No se han definido perfiles todavia...</td>";
                    }
                    ?>
                </tbody>
            </table>
        ...
        <div class="text-center" style="margin-bottom: 8px;">
            <a class="btn btn-default" href="<?php echo site_url('perfil/nuevo') ?>" role="button">NUEVO PERFIL</a>
        </div>
