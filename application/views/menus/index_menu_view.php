                        ...
                        $.post(
                            ...
                            function(respuesta){
                                ...
                                $.each(obj,function(i,item){
                                    // Aqui calculo el número de menús hijos de cada menú de la lista
                                    $.post(
                                        "<?php echo site_url('menu/contarMenusHijos') ?>",
                                        {
...
//                                            console.log(registro);
                                            $("#tblMenus tbody").append(
                                                '<tr>'+
                                                    ...
                                                    '<td><a href="'+'<?php echo $base_url ?>menu/submenus/'+item.id_menu+'/'+id_perfil+'">Submenús</a>'+
                                                    ' <span class="badge">'+registro['contador']+'</span></td>'+
                                                    '<td><a href="'+'<?php echo $base_url ?>menu/editar/'+item.id_menu+'/'+id_perfil+'">Editar</a></td>'+
            ...
            function nuevoMenu(){
                ...
                location.href = "<?php echo site_url('menu/nuevo/') ?>"+id_perfil;
            }
            ...
            function eliminar(id_menu) {
                if(confirm("¿Seguro que desea eliminar este menú?")){
                    ...
                    console.log(id_menu);
                    $.post(
                        "<?php echo site_url('menu/eliminar') ?>",
                        {
                            id_menu: id_menu
                        },
                        function(respuesta){
    ...
    <body>
        ...
        <div class="row text-center color1">
            <h3>LISTA DE MENÚS EXISTENTES</h3>
        </div>

        <div class="container-fluid margin-padding text-center">
            <div class="row">
                <div id="perfiles" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div id="btnNuevoMenu" class="text-center div-oculto" style="margin-bottom: 8px;">
            <a class="btn btn-default" href="#" onclick="nuevoMenu()" role="button">NUEVO MENÚ</a>
        </div>
