...
<html lang="es">
    ...
    <head>
        ...
        <title>SIAE Editar Institución</title>
        ...
        <script type="text/javascript">
            $(document).on("ready", function () {
                ...
                $("#edit_institucion").submit(function(event){
                    event.preventDefault();
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('institucion/actualizar/'.$id); ?>",
                        {
                            nombre: $("#nombre").val(),
    ...
    <body>
        ...
        <!-- Aqui va el formulario de edición de una institución -->
        <form id="edit_institucion" class="form-horizontal form-margin" role="form" method="post" action="">
            <div class="form-group" style="margin-top: 8px">
                <label for="nombre" class="col-sm-2 control-label">Nombre:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre de la Institución" 
                        value="<?php echo $institucion->in_nombre ?>" required autofocus>
                </div>    
            </div>
            <div class="form-group" style="margin-top: 8px">
                <label for="direccion" class="col-sm-2 control-label">Dirección:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="direccion" name="direccion" type="text" placeholder="Dirección de la Institución" 
                        value="<?php echo $institucion->in_direccion ?>" required>
                </div>    
            </div>
            <div class="form-group" style="margin-top: 8px">
                <label for="telefono" class="col-sm-2 control-label">Teléfono:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="telefono" name="telefono" type="text" placeholder="Teléfono de la Institución" 
                        value="<?php echo $institucion->in_telefono ?>" required>
                </div>    
            </div>
            <div class="form-group" style="margin-top: 8px">
                <label for="rector" class="col-sm-2 control-label">Nombre del Rector(a):</label>
                <div class="col-sm-10">
                    <input class="form-control" id="rector" name="rector" type="text" placeholder="Nombre del Rector(a)" 
                        value="<?php echo $institucion->in_nom_rector ?>" required>
                </div>    
            </div>
            <div class="form-group" style="margin-top: 8px">
                <label for="secretario" class="col-sm-2 control-label">Nombre del Secretario(a):</label>
                <div class="col-sm-10">
                    <input class="form-control" id="secretario" name="secretario" type="text" placeholder="Nombre del Secretario(a)" 
                        value="<?php echo $institucion->in_nom_secretario ?>" required>
                </div>    
            </div>
