...
<html lang="es">
    ...
    <head>
        ...
        <title>SIAE Nuevo Periodo de Evaluación</title>
        ...
        <script type="text/javascript">
            $(document).on("ready", function () {
                ...
                $("#new_periodo_evaluacion").submit(function(event){
                    ...
                    if(pe_tipo==0){
                        ...
                        $("#img_loader").show();
                        $.post(
                            "<?php echo site_url('periodo_evaluacion/recibirdatos'); ?>",
                            {
                                nombre: $("#nombre").val(),
    ...
    <body>
        ...
        <div class="row text-center color1">
            <h3>INGRESAR UN NUEVO PERIODO DE EVALUACIÓN</h3>
        </div>
        ...
        <form id="new_periodo_evaluacion" class="form-horizontal form-margin" role="form" method="post" action="">
            <div class="form-group" style="margin-top: 8px">
                <label for="nombre" class="col-sm-2 control-label">Nombre:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre del Periodo de Evaluación" value="" required autofocus>
                </div>    
            </div>
            <div class="form-group" style="margin-top: 8px">
                <label for="abreviatura" class="col-sm-2 control-label">Abreviatura:</label>
                <div class="col-sm-10">
                    <input class="form-control" id="abreviatura" name="abreviatura" type="text" placeholder="Abreviatura del Periodo de Evaluación" value="" required autofocus>
                </div>    
            </div>
            <div class="form-group" style="margin-top: 8px">
