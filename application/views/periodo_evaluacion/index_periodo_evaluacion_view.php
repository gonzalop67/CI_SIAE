...
<html lang="es">
    ...
    <head>
        ...
        <title>SIAE Periodos de Evaluación</title>
        ...
        <script type="text/javascript">
            ...
            function eliminar(id_periodo_evaluacion) {
                if(confirm("¿Seguro que desea eliminar este periodo de evaluación?")){
                    $("#img_loader").show();
                    $.post(
                        "<?php echo site_url('periodo_evaluacion/eliminar') ?>",
                        {
                        ...
                        function(respuesta){
                            ...
                            alert(resp['mensaje']);
                            location.href = "<?php echo site_url('periodo_evaluacion') ?>"
                        }
                    );
                }
            }
    ...
    <body>
        ...
        <div class="row text-center color1">
            <h3>LISTA DE PERIODOS DE EVALUACIÓN EXISTENTES</h3>
        </div>
                ...
                <tbody>
                    ...
                    if ($periodos_evaluacion) {
                        ...
                        foreach ($periodos_evaluacion->result() as $periodo_evaluacion) {
                            ...
                            echo "<tr><td>$id</td>\n";
                            echo "<td>$name</td>\n";
                            echo "<td><a href='periodo_evaluacion/editar/$id'>Editar</a></td>\n";
                            echo "<td><a href='#' onclick='eliminar(".$id.")'>Eliminar</a></td></tr>\n";
                        }
                    } else {
                        echo "<td colspan='4' align='center'>No se han definido periodos de evaluación todavia...</td>";
                    }
                    ?>
                </tbody>
            </table>
        ...
        <div class="text-center" style="margin-bottom: 8px;">
            <a class="btn btn-default" href="<?php echo site_url('periodo_evaluacion/nuevo') ?>" role="button">NUEVO PERIODO DE EVALUACIÓN</a>
        </div>
